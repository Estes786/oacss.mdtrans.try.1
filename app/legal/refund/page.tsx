    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="legal-content py-12">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-green-800">
                We stand behind our service quality. If you're not satisfied within the first 7 days 
        ...
        <section className="mb-8">
          ...
          <ul>
            <li><strong>Within 7 Days:</strong> You request a refund within 7 days of your initial subscription purchase</li>
            <li><strong>Service Unavailability:</strong> Our service was unavailable for more than 24 consecutive hours</li>
            <li><strong>Technical Issues:</strong> Persistent technical problems that prevent you from using core features, and we were unable to resolve them within a reasonable timeframe</li>
            <li><strong>Billing Errors:</strong> You were charged incorrectly or accidentally charged multiple times</li>
            <li><strong>Unauthorized Charges:</strong> Your account was charged without your authorization</li>
        ...
        <section className="mb-8">
          ...
          <ul>
            <li><strong>Calculation:</strong> (Remaining months / 12) × Annual subscription amount</li>
            <li><strong>Minimum:</strong> At least 3 months must remain in subscription</li>
            <li><strong>Exclusions:</strong> Promotional discounts are non-refundable</li>
          </ul>
          <p><strong>Example:</strong> If you paid Rp 30,000,000 for annual Enterprise plan and cancel after 6 months, you'll receive: (6/12) × Rp 30,000,000 = Rp 15,000,000</p>
        ...
        <section className="mb-8">
          ...
          <p>Email us at <a href="mailto:elfaress2425@gmail.com" className="text-blue-600 hover:underline">elfaress2425@gmail.com</a> with:</p>
          <ul>
            <li><strong>Subject:</strong> "Refund Request - [Your Order ID]"</li>
            <li><strong>Your full name</strong> as registered on account</li>
            <li><strong>Email address</strong> associated with account</li>
            <li><strong>Order ID</strong> (found in transaction confirmation email)</li>
            <li><strong>Reason for refund</strong> with specific details</li>
            <li><strong>Payment proof</strong> (receipt or transaction screenshot)</li>
          </ul>
          ...
          <ul>
            <li><strong>Approval:</strong> Refund amount and processing timeline</li>
            <li><strong>Denial:</strong> Reason for denial and alternative solutions</li>
            <li><strong>Partial Approval:</strong> Modified refund amount with explanation</li>
          </ul>

          <h3>Step 4: Processing</h3>
          <p>If approved, refund will be processed within:</p>
          <ul>
            <li><strong>Bank Transfer / VA:</strong> 5-10 business days to original account</li>
            <li><strong>E-Wallet (GoPay, Dana, OVO):</strong> 3-7 business days</li>
            <li><strong>Credit Card:</strong> 10-14 business days (depends on bank)</li>
            <li><strong>QRIS:</strong> 5-10 business days to linked account</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p><strong>Important:</strong> Cancelling your subscription does not automatically trigger a refund.</p>
          <ul>
          ...
          <ul>
            <li><strong>Monthly:</strong> Downgrade takes effect on next billing cycle (no refund for current period)</li>
            <li><strong>Annual:</strong> Prorated credit applied to next invoice or refunded upon request</li>
          </ul>
        ...
        <section className="mb-8">
          ...
          <ul>
            <li><strong>Bank Transfer / VA:</strong> Fully refundable</li>
            <li><strong>E-Wallets:</strong> Fully refundable to wallet balance</li>
            <li><strong>Credit/Debit Card:</strong> Fully refundable (subject to bank processing)</li>
            <li><strong>QRIS:</strong> Refunded to linked account</li>
          </ul>
        ...
        <section className="mb-8">
          ...
          <ol>
            <li><strong>Initial Contact:</strong> Email elfaress2425@gmail.com with "Complaint - Refund Denied"</li>
            <li><strong>Management Review:</strong> Your case will be escalated to senior management</li>
            <li><strong>Response:</strong> You'll receive a response within 7 business days</li>
            <li><strong>Resolution:</strong> Final decision will be made and communicated</li>
          </ol>
        ...
        <section className="mb-8">
          ...
          <p>
            Significant changes will take effect 30 days after notification. Your continued use of 
        ...
        <section className="mb-8">
          ...
          <ul>
            <li><strong>Email:</strong> <a href="mailto:elfaress2425@gmail.com" className="text-blue-600 hover:underline">elfaress2425@gmail.com</a></li>
            <li><strong>Phone:</strong> <a href="tel:+6285712658316" className="text-blue-600 hover:underline">+62 857-1265-8316</a></li>
            <li><strong>Business Hours:</strong> Monday - Friday, 09:00 - 18:00 WIB</li>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-blue-800">
                Our refund policy is designed to be fair and transparent. We value customer satisfaction 
                and will work with you to resolve any issues. If you have questions about refund eligibility, 
                don't hesitate to contact us before requesting a refund.
              </p>
            </div>
          </div>
        </div>
